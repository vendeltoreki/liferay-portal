...
public class Origin implements Serializable {
	...
	public static Origin toDTO(String json) {
		return ObjectMapperUtil.readValue(Origin.class, json);
	}

	public static Origin unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(Origin.class, json);
	}
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.exportimport.rest.dto.v1_0.Origin",
		name = "x-class-name"
	)
...
// LIFERAY-REST-BUILDER-HASH:405815576