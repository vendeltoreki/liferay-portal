...
public class SiteConfiguration implements Serializable {
	...
	public static SiteConfiguration toDTO(String json) {
		return ObjectMapperUtil.readValue(SiteConfiguration.class, json);
	}

	public static SiteConfiguration unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(SiteConfiguration.class, json);
	}
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.headless.admin.configuration.dto.v1_0.SiteConfiguration",
		name = "x-class-name"
	)
...
// LIFERAY-REST-BUILDER-HASH:541763807