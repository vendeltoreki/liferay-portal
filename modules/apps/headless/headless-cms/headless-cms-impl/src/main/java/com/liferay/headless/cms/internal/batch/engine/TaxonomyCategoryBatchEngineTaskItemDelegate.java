...
public class TaxonomyCategoryBatchEngineTaskItemDelegate
	extends BaseBatchEngineTaskItemDelegate<ObjectEntry> {
	...
	public boolean hasUpdateStrategy(String updateStrategy) {
		if (updateStrategy.equals("UPDATE") ||
			updateStrategy.equals("PARTIAL_UPDATE")) {
	...
	public void update(
		...
		BatchEngineTaskItemDelegate<ObjectEntry> batchEngineTaskItemDelegate =
			(BatchEngineTaskItemDelegate<ObjectEntry>)
				_batchEngineTaskItemDelegateRegistry.
					getBatchEngineTaskItemDelegate(
						contextCompany.getCompanyId(),
						ObjectEntry.class.getName(), "Blog");
