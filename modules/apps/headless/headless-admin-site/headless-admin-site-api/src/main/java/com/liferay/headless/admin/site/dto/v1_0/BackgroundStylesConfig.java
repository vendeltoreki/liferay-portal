 ...
 */
@Generated("")
@GraphQLName("BackgroundStylesConfig")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "BackgroundStylesConfig")
public class BackgroundStylesConfig implements Serializable {

	public static BackgroundStylesConfig toDTO(String json) {
		return ObjectMapperUtil.readValue(BackgroundStylesConfig.class, json);
	}

	public static BackgroundStylesConfig unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(
			BackgroundStylesConfig.class, json);
	}
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.headless.admin.site.dto.v1_0.BackgroundStylesConfig",
		name = "x-class-name"
	)
...
// LIFERAY-REST-BUILDER-HASH:-759065900