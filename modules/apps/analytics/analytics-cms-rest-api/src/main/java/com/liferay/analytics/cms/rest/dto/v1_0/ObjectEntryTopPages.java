 ...
 */
@Generated("")
@GraphQLName("ObjectEntryTopPages")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "ObjectEntryTopPages")
public class ObjectEntryTopPages implements Serializable {

	public static ObjectEntryTopPages toDTO(String json) {
		return ObjectMapperUtil.readValue(ObjectEntryTopPages.class, json);
	}

	public static ObjectEntryTopPages unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(
			ObjectEntryTopPages.class, json);
	}

	@io.swagger.v3.oas.annotations.media.Schema
	@Valid
	public TopPage[] getTopPages() {
		if (_topPagesSupplier != null) {
			topPages = _topPagesSupplier.get();

			_topPagesSupplier = null;
		}
	...
	public void setTopPages(
		...
		_topPagesSupplier = () -> {
			try {
				return topPagesUnsafeSupplier.get();
			}
	...
	@JsonIgnore
	private Supplier<TopPage[]> _topPagesSupplier;
	...
	public String toString() {
		...
		if (topPages != null) {
			...
			for (int i = 0; i < topPages.length; i++) {
				sb.append(String.valueOf(topPages[i]));

				if ((i + 1) < topPages.length) {
					sb.append(", ");
				}
			}
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.analytics.cms.rest.dto.v1_0.ObjectEntryTopPages",
		name = "x-class-name"
	)
...
// LIFERAY-REST-BUILDER-HASH:966484335